  ...
  return (
    <div className="flex items-center gap-2 py-2 px-1">
      <div aria-label={text} role="status" className="flex items-center">
        <svg className="h-5 w-5 animate-spin stroke-black dark:stroke-white" viewBox="0 0 256 256" fill="none">
        ...
        <span className="ml-2 text-[13px] font-medium text-black/60 dark:text-white/60">
          {text}
        </span>
      </div>
    </div>
