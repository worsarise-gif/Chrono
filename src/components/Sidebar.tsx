...
export default function Sidebar({ isMobileOpen, setIsMobileOpen }: { isMobileOpen?: boolean, setIsMobileOpen?: (val: boolean) => void }) {
  ...
  return (
    <>
      ...
      <div className={`h-[100dvh] bg-sidebar-bg text-foreground border-r border-border z-50 font-sans font-light transition-all duration-300 ease-in-out fixed md:relative ${isCollapsed ? 'w-[68px] overflow-hidden' : 'w-[250px] overflow-hidden'} ${isMobileOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
