    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-foreground/60">Secure portal for Chrono administrators</p>
        </div>
        ...
        <div className="mt-10 pt-8 border-t border-border/50 flex items-center justify-center gap-2">
          ...
          <span className="text-[10px] uppercase tracking-[0.2em] text-foreground/20 font-bold">Chrono Control Panel</span>
        </div>
      </motion.div>
    </div>
  );
