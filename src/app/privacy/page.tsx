  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full bg-[#0a0a0a] text-white font-sans font-extralight overflow-y-auto">
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 py-8 sm:px-8 md:px-12">
        <h1 className="text-3xl sm:text-4xl font-normal mb-8 text-white">Privacy Policy</h1>
        ...
        <div className="space-y-6 text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-3">2. How We Use Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-3">3. Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-3">4. Sharing Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-3">5. Changes to This Policy</h2>
            <p>
