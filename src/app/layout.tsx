        ...
        >
          <ErrorBoundary>
            <AuthProvider>
              <ChatProvider>
                {/* Mobile Top Scrim */}
                <div className="fixed top-0 left-0 right-0 h-[calc(6rem+env(safe-area-inset-top))] bg-gradient-to-b from-background via-background/80 to-transparent z-[39] pointer-events-none md:hidden" />
                {children}
              </ChatProvider>
            </AuthProvider>
          </ErrorBoundary>
